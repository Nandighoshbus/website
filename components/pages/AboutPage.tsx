...
const languages = {
  en: {
    ...
    ourStory: "Our Story",
    storyContent: "For Over 25 years, Nandighosh Bus Service was born in the year 1998, not just as a transportation service, but as a dream carried forward by the unwavering dedication of two remarkable individuals — Mr. Suryakanta Nanda and Mrs. Manasi Nanda. With nothing more than sheer determination, strong values, and an unshakeable belief in hard work, they began with a single bus, serving the people of Balasore, Odisha, with honesty, punctuality, and care.",
    storyContent2: "Over the years, Nandighosh Bus became more than just a name. It became a part of everyday life for countless travelers — connecting villages, bridging families, and carrying stories across the highways of Odisha and beyond. Today, that legacy is being carried forward by their son, Saurav Kumar Nanda, who has grown up watching his parents build something from the ground up. With a deep respect for tradition and a clear vision for the future, Saurav is expanding Nandighosh Bus into a modern, technology-driven transport service — while holding tightly to the same values his parents instilled in him: trust, safety, and service from the heart. Whether you're traveling home or starting a new journey, with Nandighosh Bus, you're not just a passenger — you're part of our family.",
