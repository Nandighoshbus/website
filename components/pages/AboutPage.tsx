...
const languages = {
  en: {
    ...
    ourStory: "Our Story",
    storyContent: "For Over 25 years, Nandighosh Bus Service was born in the year 1998, not just as a transportation service, but as a dream carried forward by the unwavering dedication of two remarkable individuals — Mr. Suryakanta Nanda and Mrs. Manasi Nanda. With nothing more than sheer determination, strong values, and an unshakeable belief in hard work, they began with a single bus, serving the people of Balasore, Odisha, with honesty, punctuality, and care. Today, this legacy continues under the leadership of their son, Saurav Nanda, who operates this website and maintains the family tradition of excellence in transportation services.",
